...
<br>
        <div class="mb-3">
          ...
          <div class="col-md-1 mb-3">
            ...
            <input type="text" class="form-control" id="bln_lahir" name="bln_lahir" />
            <div class="invalid-feedback">
          ...
          <div class="col-md-1 mb-3">
            ...
            <input type="text" class="form-control" id="thn_lahir" name="thn_lahir" />
            <div class="invalid-feedback">
              tahun /.
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            ...
            <select class="custom-select d-block w-100" id="kewarganegaraan" name="kewarganegaraan" />
              <option value="">Pilih</option>
              <option>WNI</option>
              <option>WNA</option>
            </select>
...
<br>
        ...
        <select class="form-control mandatory" id="investasi" name="investasi">
              <option value="">Pilih</option>
              <option value="">Paket Setia Pasar Uang</option>
              <option value="">Paket Setia Kombinasi</option>
              <option value="">Paket Setia Pendapatan Tetap</option>
            </select>
            <br>
          </div>
        </div>
        ...
        <div class="mb-3">
            <label for="jabatan">Iuran Pemberi Kerja</label>
...
<br>
        <div class="mb-3">
          ...
          <div class="col-md-3 mb-3">
            <label for="tempat">Tempat & Tanggal Lahir</label>
            <input type="text" class="form-control" id="tempat2" name="tempat2" placeholder="Tempat" />
            <div class="invalid-feedback">
              Valid ttl is /.
            </div>
          </div>
          <div class="col-md-1 mb-3">
            <label for="tgl_lahir2">Tanggal</label>
            <input type="text" class="form-control" id="tgl_lahir2" name="tgl_lahir2" />
            <div class="invalid-feedback">
              Please select a valid tgl.
            </div>
          </div>
          <div class="col-md-1 mb-3">
            <label for="bln_lahir2">Bulan</label>
            <input type="text" class="form-control" id="bln_lahir2" name="bln_lahir2" />
            <div class="invalid-feedback">
              Please provide a valid bln.
            </div>
          </div>
          <div class="col-md-1 mb-3">
            <label for="thn_lahir2">Tahun</label>
            <input type="text" class="form-control" id="thn_lahir2" name="thn_lahir2" />
            <div class="invalid-feedback">
              tahun /.
            </div>
          </div>
        ...
        <div class="mb-3">
          <label for="alamat">Alamat</label>
          <input type="text" class="form-control" id="alamat2" name="alamat2" placeholder="1234 Main St" />
          <div class="invalid-feedback">
            Alamat harap diisi.
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            <label for="kecamatan">Kecamatan</label>
            <input type="text" class="form-control" id="kecamatan2" name="kecamatan2" placeholder="" />
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            <label for="zip2">Kode Pos</label>
            <input type="text" class="form-control" id="zip2" name="zip2" />
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            <label for="nama_kantor">Nama Perusahaan</label>
        ...
        <div class="col-md-4 mb-3">
          <label for="kec_kantor">Kecamatan</label>
          <input type="text" class="form-control" id="kec_kantor" name="kec_kantor"/> 
        </div>
        </div>
       ...
       <div class="mb-3">
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            <label for="tempat">Tempat & Tanggal Lahir</label>
            <input type="text" class="form-control" id="tempat3" name="tempat3" placeholder="Tempat"/>
            <div class="invalid-feedback">
              Valid ttl is /.
            </div>
          </div>
          <div class="col-md-1 mb-3">
            <label for="tgl_lahir3">Tanggal</label>
            <input type="text" class="form-control" id="tgl_lahir3" name="tgl_lahir3" />
            <div class="invalid-feedback">
              Please select a valid tgl.
            </div>
          </div>
          <div class="col-md-1 mb-3">
            <label for="bln_lahir3">Bulan</label>
            <input type="text" class="form-control" id="bln_lahir3" name="bln_lahir3" />
            <div class="invalid-feedback">
              Please provide a valid bln.
            </div>
          </div>
          <div class="col-md-1 mb-3">
            <label for="thn_lahir3">Tahun</label>
            <input type="text" class="form-control" id="thn_lahir3" name="thn_lahir3" />
            <div class="invalid-feedback">
              tahun /.
            </div>
          </div>
        ...
        <div class="col-md-4 mb-3">
          ...
          <input type="text" class="form-control" id="kecamatan3" name="kecamatan3"/>
          <div class="invalid-feedback">
            Nomor Hp harap diisi.
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          <label for="zip3">Kode Pos</label>
          <input type="text" class="form-control" id="zip3" name="zip3"/>
          <div class="invalid-feedback">
            Nomor Hp harap diisi.
          </div>
        </div>
      ...
      <div class="row">
          <div class="col-md-3 mb-3">
            ...
            <select class="custom-select d-block w-100" id="pekerjaan2" name="pekerjaan2" />
              <option value="">Pilih</option>
              <option>Karyawan</option>
              <option>Wiraswasta</option>
              <option>Profesional</option>
        ...
        <div class="mb-3">
          <label for="nama_kantor2">Nama Perusahaan</label>
          <input type="text" class="form-control" id="nama_kantor2" name="nama_kantor2"/>
          <div class="invalid-feedback">
            Nomor Hp harap diisi.
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="row">
        <div class="col-md-4 mb-3">
          <label for="jabatan2">Jabatan Pekerjaan</label>
