    ...
    <div class="col-lg-8 mx-auto">
      <form action="connect3.php" method="post">
        ...
        <div class="col-md-6 mb-3">
            <label for="noRum">Telpon Rumah</label>
            <input type="text" class="form-control" id="noRum" name="noRum" placeholder="(02x)-xxxxxx" value="" required>
            <div class="invalid-feedback">
      ...
      <select class="form-control mandatory" id="jenis_Penghasilan" name="jenis_Penghasilan">
       <option value="">Pilih Penghasilan (wajib)</option>
              <option value="2500000">1: s/d 5 juta</option>
