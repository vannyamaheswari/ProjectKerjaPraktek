          ...
          <div class="row justify-content-center">
            <div class="col-lg-6">
              <div class="banner_content text-center">
                <h2>e-form Pembukaan Rekening Bima Platinum</h2>
                <div class="page_link">
                  <p>Lembaga</p>
              </div>
            </div>
    ...
    <div class="col-lg-8 mx-auto">
      <form action="connect4.php" method="post">
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            <label for="usaha">Badan Usaha</label>
            <select class="custom-select d-block w-100" id="usaha" name="usaha" required>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="noFax" placeholder="(02x)xxxxxx"/>
            <div class="invalid-feedback">
               Nomor telpon harap diisi.
            </div>
          </div>
          <div class="col-md-6 mb-3">
            <label for="noFax">-</label>
            <input type="text" class="form-control" id="noFax" placeholder="nomor telp" value="" name="noFax" required>
            <div class="invalid-feedback">
               Nomor telpon harap diisi.
            </div>
          </div>
          ...
          <div class="mb-3">
          <label for="nomerNpwp">Nomor NPWP</label>
          <input type="text" class="form-control" id="nomerNpwp" placeholder="15 digit" name="nomerNpwp" required>
          <div class="invalid-feedback">
            harap diisi.
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-3 mb-3">
            ...
            <select class="custom-select d-block w-100" id="Negaraan" name="Negaraan" required>
              <option value="">Pilih</option>
              <option>WNI</option>
              <option>WNA</option>
            </select>
        ...
        <div class="row">
          <div class="col-md-2 mb-3">
            ...
            <select class="custom-select d-block w-100" id="jen_kel" name="jen_kel" required>
              <option value="">Pilih</option>
              <option>Pria</option>
        ...
        <div class="col-md-2 mb-3">
         ...
         <div class="row">
          <div class="col-md-3 mb-3">
            ...
            <select class="custom-select d-block w-100" id="pendidikan" name="pendidikan" required>
              <option value="">Pilih</option>
              <option>S3</option>
              <option>S2</option>
              <option>S1</option>
        ...
        <div class="col-md-5 mb-3">
            ...
            <input type="text" class="form-control" id="namakantor" placeholder="" name="namakantor" value="" required>
            <div class="invalid-feedback">
              Valid first name is required.
            </div>
          </div>
          <div class="col-md-5 mb-3">
            ...
            <input type="text" class="form-control" id="jabatan" placeholder="" value="" name="jabatan" required>
            <div class="invalid-feedback">
              Valid first name is required.
            </div>
          </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="alm_kantor" placeholder="1234 Main St" name="alm_kantor" required>
          <div class="invalid-feedback">
            Alamat harap diisi.
          </div>
        </div>
       ...
       <div class="mb-3">
          ...
          <input type="text" class="form-control" id="tel_kantor" placeholder="" name="tel_kantor" required>
          <div class="invalid-feedback">
      ...
      <select class="form-control mandatory" id="jenis_Penghasilan" name="jenis_Penghasilan">
       <option value="">Pilih Penghasilan (wajib)</option>
              <option value="5000000">1: s/d 5 juta</option>
              <option value="7500000">2: &gt;5 juta - 10 juta</option>
              <option value="12500000">3: &gt;10 juta - 25 juta</option>
              <option value="25000000">4: &gt;25 juta - 50 juta</option>
              <option value="50000000">5: &gt;50 juta</option>
      </select>
      </div>
